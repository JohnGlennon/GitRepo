...
{
    public static PB_MVC.Controllers.AccountController Account = new PB_MVC.Controllers.T4MVC_AccountController();
    public static PB_MVC.Controllers.HomeController Home = new PB_MVC.Controllers.T4MVC_HomeController();
    public static PB_MVC.Controllers.ManageController Manage = new PB_MVC.Controllers.T4MVC_ManageController();
